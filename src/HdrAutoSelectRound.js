function SvgHdrAutoSelectRound(props) {
	return (
		<svg
			...
			<path d='M12 2C8.69 2 6 4.69 6 8s2.69 6 6 6 6-2.69 6-6-2.69-6-6-6zm2.44 9c-.24 0-.45-.15-.53-.38l-.49-1.41h-2.83l-.5 1.41a.564.564 0 11-1.06-.38l2.12-5.65a.906.906 0 011.7 0l2.12 5.65a.56.56 0 01-.53.76z' />
		</svg>
	);
}

export default SvgHdrAutoSelectRound;
